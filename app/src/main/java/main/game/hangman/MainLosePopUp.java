...
public class MainLosePopUp extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.losepopup_main);
        ...
        buttonReturn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(MainLosePopUp.this, MainActivity.class);
